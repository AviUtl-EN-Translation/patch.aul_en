...
namespace patch {
    ...
    inline class failed_longer_path_t {
        ...
        inline static const char str_new_longer_msg[] = "The operation failed because the file path is too long.\nPlease shorten the file or folder name, or move it to a shallower directory such as directly under the C drive.";
